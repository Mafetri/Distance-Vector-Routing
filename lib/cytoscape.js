...
var fe = function (e, t, n) {
	...
	je = function (e, t) {
		for (
			t = e = "";
			e++ < 36;
			t += (51 * e) & 52 ? (15 ^ e ? 8 ^ (Math.random() * (20 ^ e ? 16 : 4)) : 4).toString(16) : "-"
		);
		return t;
	},
	qe = {},
	...
	Qe = function (e, t) {
		...
		if (void 0 !== e && void 0 !== t && k(e)) {
			...
			if (
				...
				if (
					(null == i.position.x && (i.position.x = 0), null == i.position.y && (i.position.y = 0), t.renderedPosition)
				) {
	...
	Je = function (e) {
		return (
			...
			function (t, n, r) {
				var i;
				y(t) && !x(t) && ((t = (i = t).roots || i.root), (n = i.visit), (r = i.directed)),
				...
				for (
					var C = function () {
						...
						for (
							...
							0 === k.length ||
								h[C] ||
								((k = k[0]), l.push(k), e.bfs && ((h[C] = !0), u.push(k)), (c[C] = E), (d[C] = d[i] + 1));
						}
					};
					0 !== l.length;
		...
		(function () {
			...
			(r = Math.floor),
				...
				(s = function (e, t, r) {
					var i;
					return (
						null == r && (r = n), e.length && r(e[0], t) < 0 && ((t = (i = [e[0], t])[0]), (e[0] = i[1]), g(e, 0, r)), t
					);
				}),
				(i = function (e, t) {
					var i, a, o, s, l, u;
		...
		bellmanFord: function (e) {
			...
			if (k)
				for (var z = [], I = 0; I < y; I++) {
					...
					if (V + R < F || (!i && F + R < V)) {
						if (
							(g || (Ve("Graph contains a negative weight cycle for Bellman-Ford"), (g = !0)),
			...
			return {
				...
				pathTo: function (e) {
					for (
						var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : a, r = b(e), i = [], o = r;
						;
...
var ln = Xe({
	...
	un = {
		...
		closenessCentrality: function (e) {
			...
			n = this.filter(n)[0];
			for (
				var o = this.dijkstra({ root: n, weight: r, directed: i }), s = 0, l = this.nodes(), u = 0;
				u < l.length;
				u++
			) {
				var c = l[u];
...
var hn = Xe({
	...
	xn = function (e) {
		...
		for (var y = !0, m = 0; y && m < i.maxIterations; )
			(y = !1), (s = vn(c, l, i.expandFactor)), (c = yn(s, l, i.inflateFactor)), mn(c, s, u, 4) || (y = !0), m++;
		...
		return (b = (function (e) {
			for (var t = 0; t < e.length; t++) for (var n = 0; n < e.length; n++) t != n && bn(e[t], e[n]) && e.splice(n, 1);
			return e;
		})(b));
	},
	...
	Tn = function (e, t, n, r, i) {
		for (var a = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : En, o = r, s = 0; s < e; s++)
			o = i(o, t(s), n(s));
		return a(o);
	},
	_n = {
...
var Bn = Xe({
	...
	Yn = function (e) {
		...
		for (var v = !0, y = 0; v && y < s.maxIterations; )
			(v = !1), jn(t, o, n, i, s), qn(n, r, t, o, s), On(n, r, s.sensitivityThreshold) || (v = !0), y++;
		return {
	...
	Xn = {
		kMeans: function (t) {
			...
			o.testMode
				? "number" == typeof o.testCentroids
					...
					: (n = "object" === e(o.testCentroids) ? o.testCentroids : In(i, o.k, o.attributes))
		...
		kMedoids: function (t) {
			var n,
				...
				c = new Array(s.k);
			s.testMode
				? "number" == typeof s.testCentroids || (n = "object" === e(s.testCentroids) ? s.testCentroids : Vn(a, s.k))
				: (n = Vn(a, s.k));
				...
				for (var f = 0; f < n.length; f++) {
					...
					if (0 !== g.length) {
						...
						for (var v = 0; v < g.length; v++)
							(r = Fn(g[v], g, s.attributes)) < c[f] && ((c[f] = r), (n[f] = g[v]), (d = !0));
						l[f] = i.collection(g);
					}
				}
				h++;
			...
			"dendrogram" === r.mode
				? ((g = (function e(t, n, r) {
						...
						var i = [],
							...
							o = [];
						return 0 === n
							? (t.left && Gn(t.left, i), t.right && Gn(t.right, a), (o = i.concat(a)), [r.collection(o)])
							: 1 === n
							? t.value
								? [r.collection(t.value)]
								: (t.left && Gn(t.left, i), t.right && Gn(t.right, a), [r.collection(i), r.collection(a)])
							: t.value
							? [r.collection(t.value)]
		...
		for (k = 0; k < u.maxIterations; k++) {
			for (var P = 0; P < t; P++) {
				for (var D = -1 / 0, T = -1 / 0, _ = -1, M = 0, B = 0; B < t; B++)
					(b[B] = a[P * t + B]),
						(M = o[P * t + B] + r[P * t + B]) >= D ? ((T = D), (D = M), (_ = B)) : M > T && (T = M);
...
[
	...
	nr,
	{
		hierholzer: function (e) {
			...
			for (v = p(i); 1 != v.length; )
				0 == c[v[0]].length
					? (g.unshift(l.getElementById(v.shift())), g.unshift(l.getElementById(v.shift())))
	...
	{ hopcroftTarjanBiconnected: ir, htbc: ir, htb: ir, hopcroftTarjanBiconnectedComponents: ir },
	{ tarjanStronglyConnected: ar, tsc: ar, tscc: ar, tarjanStronglyConnectedComponents: ar },
].forEach(function (e) {
	I(or, e);
});
/*!
...
I(gr, {
	...
	play: function () {
		var e = this._private;
		return (
			1 === e.progress && (e.progress = 0), (e.playing = !0), (e.started = !1), (e.stopped = !1), this.hook(), this
		);
	},
	playing: function () {
...
var xr = function (e, t) {
	...
	var n = typeof e;
	return (
		!("number" != n && "symbol" != n && "boolean" != n && null != e && !oe(e)) ||
		br.test(e) ||
		!mr.test(e) ||
...
var ni = ti,
	ri = Ar(Y, "Map");
var ii = function () {
	(this.size = 0), (this.__data__ = { hash: new Hr(), map: new (ri || ni)(), string: new Hr() });
};
var ai = function (e) {
	var t = typeof e;
					...
					if (f(t)) {
						...
						if (r.allowGetting && void 0 === n)
							return (
								s &&
									(r.beforeGet(s),
									(l = u && void 0 === s._private[r.field][t] ? Pi(s._private[r.field], u) : s._private[r.field][t])),
								l
							);
				...
				function (t) {
					...
					if (f(t)) {
						for (var i = t.split(/\s+/), a = i.length, o = 0; o < a; o++) {
							var s = i[o];
							if (!S(s))
								if (!n.immutableKeys[s]) for (var l = 0, u = r.length; l < u; l++) r[l]._private[n.field][s] = void 0;
						}
...
(Fi.variable = "(?:[\\w-.]|(?:\\\\" + Fi.metaChar + "))+"),
	...
	(function () {
		...
		for (e = Fi.comparatorOp.split("|"), n = 0; n < e.length; n++)
			(t = e[n]).indexOf("!") >= 0 || ("=" !== t && (Fi.comparatorOp += "|\\!" + t));
	})();
var ji = 0,
	qi = 1,
	Yi = 2,
	...
	pa = [
		...
		},
		{
			...
			populate: function (e, t, n) {
				var r = a(n, 3),
					...
					o = r[1],
					s = r[2];
				(s = null != new RegExp("^" + Fi.string + "$").exec(s) ? s.substring(1, s.length - 1) : parseFloat(s)),
		...
		},
		{
			...
			populate: function (e, t, n) {
				var r = a(n, 3),
					...
					o = r[1],
					s = r[2];
				t.checks.push({ type: Ki, field: da(i), operator: o, value: parseFloat(s) });
			},
		},
		{
			name: "nextQuery",
			...
			populate: function (e, t) {
				if (null == e.currentSubject) {
					var n = { checks: [] },
						r = t,
						i = { checks: [] };
					return n.checks.push({ type: Qi, source: r, target: i }), ha(e, 0, n), e.edgeCount++, i;
				}
				var a = { checks: [] },
					o = t,
					s = { checks: [] };
				return a.checks.push({ type: Ji, source: o, target: s }), ha(e, 0, a), e.edgeCount++, s;
			},
		},
		{
			name: "undirectedEdge",
			...
			populate: function (e, t) {
				if (null == e.currentSubject) {
					var n = { checks: [] },
						r = t,
						i = { checks: [] };
					return n.checks.push({ type: $i, nodes: [r, i] }), ha(e, 0, n), e.edgeCount++, i;
				}
				var a = { checks: [] },
					o = t,
					s = { checks: [] };
				return a.checks.push({ type: ta, node: o, neighbor: s }), ha(e, 0, a), s;
			},
		},
		{
			name: "child",
			...
			populate: function (e, t) {
				if (null == e.currentSubject) {
					var n = { checks: [] },
						r = { checks: [] },
						i = e[e.length - 1];
					return n.checks.push({ type: na, parent: i, child: r }), ha(e, 0, n), e.compoundCount++, r;
				}
			...
			populate: function (e, t) {
				if (null == e.currentSubject) {
					var n = { checks: [] },
						r = { checks: [] },
						i = e[e.length - 1];
					return n.checks.push({ type: ra, ancestor: i, descendant: r }), ha(e, 0, n), e.compoundCount++, r;
				}
				if (e.currentSubject === t) {
					var a = { checks: [] },
						o = e[e.length - 1],
		...
		},
		{
			...
			populate: function (e, t) {
				...
				r === Qi
					? (n.type = ea)
					: r === $i && ((n.type = ta), (n.node = n.nodes[1]), (n.neighbor = n.nodes[0]), (n.nodes = null));
			},
		},
	];
		...
		parse: function (e) {
			...
			for (var s = 0; s < this.length; s++) {
				...
				if (l.compoundCount > 0 && l.edgeCount > 0)
					return (
						Ve("The selector `" + e + "` is invalid because it uses both a compound selector and an edge selector"), !1
					);
				if (l.edgeCount > 1)
...
[
	ga,
	{
		...
		filter: function (e) {
			var t = this;
			if (1 === t.length && 1 === t[0].checks.length && t[0].checks[0].type === Ui)
		...
		if (!t.cy().headless()) {
			...
			if (t.pstyle(r + "label").strValue) {
				...
				if (M || B) {
					...
					var O = function (e, t) {
							return { x: (e -= L) * z - (t -= A) * I + L, y: e * I + t * z + A };
						},
						R = O(o, l),
						V = O(o, u),
						F = O(s, l),
		...
		if (b) {
								...
								if (a > 0 && o > 0) {
									...
									if ((Bt(e, [Math.ceil(p / 2), Math.ceil(f / 2)]), 0 !== h)) {
										var g =
											((r = 0),
											(i = h),
											{ x1: (n = e).x1 + r, x2: n.x2 + r, y1: n.y1 + i, y2: n.y2 + i, w: n.w, h: n.h });
										Tt(e, g);
									}
								}
							}
			...
			if (
				(c &&
					t.includeEdges &&
					g &&
					(Ha(h, e, "mid-source"), Ha(h, e, "mid-target"), Ha(h, e, "source"), Ha(h, e, "target")),
				c)
			)
			...
			Nt(F, h),
				Bt(F, y),
				Mt(F, 1),
				c && ((n = h.x1), (r = h.x2), (i = h.y1), (a = h.y2), Ya(h, n - E, i - E, r + E, a + E));
			...
			null != q.all
				...
				c &&
					...
					g && (t.includeSourceLabels && Ka(h, e, "source"), t.includeTargetLabels && Ka(h, e, "target")));
		}
		return (
			(h.x1 = qa(h.x1)),
			(h.y1 = qa(h.y1)),
	...
	$a = function (e, t) {
		...
		if (
			(!l || u(e) || (i && u(e.source())) || u(e.target())
				? (s || e.recalculateRenderedStyle(l), (n = Ga(e, Qa)), (r.bbCache = n), (r.bbCachePosKey = o))
				: (n = r.bbCache),
			!a)
		) {
			var c = e.isNode();
...
uo.prototype = {
	...
	recycle: function (e, t) {
		if (
			((this.isImmediatePropagationStopped = this.isPropagationStopped = this.isDefaultPrevented = co),
			null != e && e.preventDefault
				? ((this.type = e.type), (this.isDefaultPrevented = e.defaultPrevented ? ho : co))
				: null != e && e.type
				? (t = e)
				: (this.type = e),
			null != t &&
		...
		function (e, t, n) {
			...
			return (
				...
				wo(
					...
					function (e, a) {
						null != n &&
							((r = [{ event: a.event, type: a.type, namespace: a.namespace, callback: n }]), (i = r.length));
						for (
							var o = function (n) {
									var i = r[n];
									if (
...
var So = {
		...
		intersect: function (e) {
			...
			for (
				var n = this.spawn(), r = e, i = this.length < e.length, a = i ? this : r, o = i ? r : this, s = 0;
				s < a.length;
				s++
			) {
				var l = a[s];
...
(Po.u = Po["|"] = Po["+"] = Po.union = Po.or = Po.add),
	(Po["\\"] = Po["!"] = Po["-"] = Po.difference = Po.relativeComplement = Po.subtract = Po.not),
	(Po.n = Po["&"] = Po["."] = Po.and = Po.intersection = Po.intersect),
	(Po["^"] = Po["(+)"] = Po["(-)"] = Po.symmetricDifference = Po.symdiff = Po.xor),
...
(Io.interactive = zo("interactive", Ao({ ok: Ro, parentOk: Vo, edgeOkViaNode: Oo }))),
...
function Xo(e) {
	(qo[e.field] = function () {
		...
		(qo[e.on] = Yo({ event: e.on, field: e.field, ableField: e.ableField, overrideAble: e.overrideAble, value: !0 })),
		(qo[e.off] = Yo({ event: e.off, field: e.field, ableField: e.ableField, overrideAble: e.overrideAble, value: !1 }));
}
Xo({
	field: "locked",
...
(Wo.clearTraversalCache = function () {
	...
	I(Wo, { edgesWith: Sa(Zo(), "edgesWith"), edgesTo: Sa(Zo({ thisIsSrc: !0 }), "edgesTo") }),
	I(Wo, {
	...
	(Jo.restore = function () {
		...
		for (t = 0; t < e.length; t++) {
			...
			if (p.isEdge()) {
				for (var x = p, w = ["source", "target"], E = w.length, k = !1, C = 0; C < E; C++) {
					...
					m(D) && (D = v[P] = "" + v[P]),
						null == D || "" === D
							? (Oe("Can not create edge `" + y + "` with unspecified " + P), (k = !0))
							: a.hasElementWithId(D) ||
							  (Oe("Can not create edge `" + y + "` with nonexistant " + P + " `" + D + "`"), (k = !0));
				}
				if (k) {
					h();
					continue;
		...
		if (e.length > 0) {
			for (var R = e.length === i.length ? i : new Qo(a, e), V = 0; V < R.length; V++) {
				var F = R[V];
				F.isNode() ||
					(F.parallelEdges().clearTraversalCache(), F.source().clearTraversalCache(), F.target().clearTraversalCache());
			}
...
function ss(e, t, n, r) {
	...
	if (!o.easingImpl)
		if (null == s) o.easingImpl = rs.linear;
			...
			f(c)
				...
				h.length > 0
					? ("spring" === d && h.push(o.duration), (o.easingImpl = rs[d].apply(null, h)))
					: (o.easingImpl = rs[d]);
		}
	var p,
		g = o.easingImpl;
	if (
		...
		var k = o.startZoom,
			C = o.zoom,
			S = null != C && r;
		S && (ls(k, C) && (a.zoom = Pt(a.minZoom, os(k, C, p, g), a.maxZoom)), e.emit("zoom")),
			(E || S) && e.emit("viewport");
		var P = o.style;
		if (P && P.length > 0 && i) {
		...
		switch (i.mapped) {
			...
			case o.fn:
				...
				if (((i.prevFnValue = L), null == L))
					return (
						Ve("Custom function mappers may not return null (i.e. `" + i.name + "` for ele `" + e.id() + "` is null)"),
						!1
					);
				...
				if (h) {
					...
					p &&
						(m(p.pfValue) && m(f.pfValue)
							...
							: v(p.value) &&
							  v(f.value) &&
							  ((g = p.value[0] !== f.value[0] || p.value[1] !== f.value[1] || p.value[2] !== f.value[2]),
							  (y = p.strValue)),
				...
				if (((r = t[s]), null != (i = e.pstyle(r, !1))))
					if (null != i.pfValue) (u[0] = Ee(o, u[0])), (u[1] = ke(o, u[1]));
						...
						for (a = i.strValue, l = 0; l < a.length; l++)
							(o = a.charCodeAt(l)), (u[0] = Ee(o, u[0])), (u[1] = ke(o, u[1]));
			return u;
		},
	};
				...
				for (var d = []; ; ) {
					...
					if (this.properties[p])
						this.parse(p, f)
							...
							: (Ve("Skipping property: Invalid property definition in: " + r), o());
...
!(function () {
	...
	var i = {
		...
		D = [];
	(Ds.pieBackgroundN = 16), D.push({ name: "pie-size", type: a.sizeMaybePercent });
...
Ts.parseImpl = function (e, t, n, r) {
			...
			if (c.color) {
				...
				if (
					!(
						...
						b[1] !== x[1] ||
						b[2] !== x[2] ||
						(b[3] !== x[3] && ((null != b[3] && 1 !== b[3]) || (null != x[3] && 1 !== x[3])))
					)
				)
					return !1;
			}
	...
	if (c.color) {
		var W = L(t);
		return W
			? { name: e, value: W, pfValue: W, strValue: "rgb(" + W[0] + "," + W[1] + "," + W[2] + ")", bypass: n }
			: null;
	}
...
var Bs = {
	...
	Ns = {
		...
		getFitViewport: function (e, t) {
			if (
				(m(e) && void 0 === t && ((t = e), (e = void 0)), this._private.panningEnabled && this._private.zoomingEnabled)
			) {
				var n, r;
				if (f(e)) {
					var i = e;
				...
				if (!x(e) || !e.empty()) {
					...
					if (
						...
						return {
							zoom: (o =
								(o =
									(o = Math.min((s - 2 * t) / n.w, (l - 2 * t) / n.h)) > this._private.maxZoom
	...
	var i = be(),
		...
		o = function (t) {
			return (
				...
				(el(r, e), (r.temperature = r.temperature * e.coolingFactor), !(r.temperature < e.minTemp))
			);
		},
		s = function () {
...
var Gs = function (e, t, n) {
		for (
			var r = n.eles.edges(),
				i = n.eles.nodes(),
				a = Dt(n.boundingBox ? n.boundingBox : { x1: 0, y1: 0, w: e.width(), h: e.height() }),
				o = {
		...
		for (u = 0; u < o.nodeSize; u++) {
			...
			((I = {}).isLocked = m.locked()),
				...
				(I.nodeRepulsion = g(n.nodeRepulsion) ? n.nodeRepulsion(m) : n.nodeRepulsion),
		...
		for (u = 0; u < o.edgeSize; u++) {
			...
			if (o.indexToGraph[_] != o.indexToGraph[M]) {
				for (
					var B = Us(P.sourceId, P.targetId, o), N = o.graphSet[B], z = 0, I = o.layoutNodes[_];
					-1 === N.indexOf(I.id);
...
var Sl = {
		...
		registerArrowShapes: function () {
			...
			s("none", { collide: Ie, roughCollide: Ie, draw: Ae, spacing: Le, gap: Le }),
			...
			function m(n) {
				...
				if ("segments" === a.edgeType || "straight" === a.edgeType || "haystack" === a.edgeType) {
					...
					for (x = a.allpts, w = 0; w + 5 < a.allpts.length; w += 4)
						if (
							Rt(e, t, x[w], x[w + 1], x[w + 2], x[w + 3], x[w + 4], x[w + 5], g) &&
							f > (r = Vt(e, t, x[w], x[w + 1], x[w + 2], x[w + 3], x[w + 4], x[w + 5]))
						)
							return v(n, r), !0;
			...
			for (
				...
				if (f.isNode()) {
					...
					if (
						...
						for (
							var x = m.rstyle.bezierPts || m.rstyle.linePts || m.rstyle.haystackPts, w = !0, E = 0;
							E < x.length;
							E++
						)
	...
	Dl = {
		calculateArrowAngles: function (e) {
			...
			((s.midtgtArrowAngle = mt(t, n)), (s.midDispX = t), (s.midDispY = n), (t *= -1), (n *= -1), d) &&
				(((f = s.allpts).length / 2) % 2 == 0 ||
					((t = -(f[(b = (m = f.length / 2 - 1) + 2)] - f[m])), (n = -(f[b + 1] - f[m + 1]))));
	...
	(Tl.tryToCorrectInvalidPoints = function (e, t) {
		...
		if ("bezier" === n.edgeType) {
			...
			if (d || h || y) {
				...
				y
					? ((n.ctrlpts[0] = n.ctrlpts[0] + C.x * (g - v)), (n.ctrlpts[1] = n.ctrlpts[1] + C.y * (g - v)))
					: ((n.ctrlpts[0] = D[0] + C.x * g), (n.ctrlpts[1] = D[1] + C.y * g));
			}
			if (p || f || x) {
				w = !0;
				...
				x
					? ((n.ctrlpts[0] = n.ctrlpts[0] + M.x * (g - b)), (n.ctrlpts[1] = n.ctrlpts[1] + M.y * (g - b)))
					: ((n.ctrlpts[0] = z[0] + M.x * g), (n.ctrlpts[1] = z[1] + M.y * g));
			}
			...
			for (var n = 0; n + 1 < t.ctrlpts.length; n += 2)
				t.allpts.push(t.ctrlpts[n], t.ctrlpts[n + 1]),
					n + 3 < t.ctrlpts.length &&
						t.allpts.push((t.ctrlpts[n] + t.ctrlpts[n + 2]) / 2, (t.ctrlpts[n + 1] + t.ctrlpts[n + 3]) / 2);
			var r;
			t.allpts.push(t.endX, t.endY),
				(t.ctrlpts.length / 2) % 2 == 0
					...
					: ((r = t.allpts.length / 2 - 3),
					  ...
					  (t.midY = Ct(t.allpts[r + 1], t.allpts[r + 3], t.allpts[r + 5], 0.5)));
						...
						for (var k = 0; k < s.eles.length; k++) {
							...
							if (!s.calculatedIntersection && d !== h && (s.hasBezier || s.hasUnbundled)) {
								...
								var _ = w.intersectLine(f.x, f.y, v, y, g.x, g.y, 0),
									...
									F = { x: -V.y, y: V.x };
								(s.nodesOverlap =
									!m(O) || E.checkPoint(_[0], _[1], 0, b, x, g.x, g.y) || w.checkPoint(B[0], B[1], 0, v, y, f.x, f.y)),
		...
		findEndpoints: function (e) {
			...
			if ("inside-to-node" === _) t = [c.x, c.y];
				...
				("outside-to-node" === _ || "outside-to-node-or-label" === _
					? (i = n)
					: ("outside-to-line" !== _ && "outside-to-line-or-label" !== _) || (i = [u.x, u.y]),
			...
			if (((v.endX = K[0]), (v.endY = K[1]), (v.arrowEndX = H[0]), (v.arrowEndY = H[1]), "inside-to-node" === D))
				t = [u.x, u.y];
				...
				("outside-to-node" === D || "outside-to-node-or-label" === D
					? (a = r)
					: ("outside-to-line" !== D && "outside-to-line-or-label" !== D) || (a = [c.x, c.y]),
...
(Bl.storeEdgeProjections = function (e) {
	...
	t.rstyle.arrowWidth =
		this.getArrowWidth(e.pstyle("width").pfValue, e.pstyle("arrow-scale").value) * this.arrowShapeWidth;
}),
...
Al.getNodeShape = function (e) {
	...
	if ("cutrectangle" === t && (e.width() < 28 || e.height() < 28))
		return (
			Ol ||
				(Ve("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), (Ol = !0)),
			"rectangle"
		);
	if (e.isParent())
		return "rectangle" === t ||
								...
								if (v) {
									if (o.boxSelectionEnabled() && D)
										b &&
											...
											b.emit("freeon"),
											w.emit("free"),
											e.dragData.didDrag && (b.emit("dragfreeon"), w.emit("dragfree"))),
											T();
								...
								e.dragData.didDrag ||
									...
									t.timeStamp - w <= a.multiClickDebounceTime()
										? (b && clearTimeout(b),
										  (x = !0),
										  (w = null),
										  r(c, ["dblclick", "dbltap", "vdblclick"], t, { x: o[0], y: o[1] }))
							...
							if (
								...
								d(u),
									y &&
										(c.emit("freeon"),
										u.emit("free"),
										e.dragData.didDrag && (c.emit("dragfreeon"), u.emit("dragfree")));
							}
						}
						(s[4] = 0),
				...
				if (!e.scrollingPage) {
					...
					if (e.hoverData.draggingEles || e.hoverData.dragging || e.hoverData.cxtStarted || 0 !== e.selection[4])
						...
						t.preventDefault(),
							...
							(s =
								null != t.deltaY ? t.deltaY / -250 : null != t.wheelDeltaY ? t.wheelDeltaY / 1e3 : t.wheelDelta / 1e3),
					...
					if (((e.hasTouchStarted = !0), E(t))) {
						...
						if (t.touches[1]) {
							...
							(B = l[0]),
								...
								(L = 0 <= k && k <= z && 0 <= S && S <= z && 0 <= C && C <= I && 0 <= P && P <= I);
							var h = n.pan(),
								f = n.zoom();
							(D = X(k, C, S, P)),
								(T = W(k, C, S, P)),
								(M = [((_ = [(k + S) / 2, (C + P) / 2])[0] - h.x) / f, (_[1] - h.y) / f]);
						...
						if (t.touches[2]) n.boxSelectionEnabled() && t.preventDefault();
							...
							if (
								null != m &&
								(m.activate(), (e.touchData.start = m), (e.touchData.starts = y), e.nodeIsGrabbable(m))
							) {
							...
							r(m, ["touchstart", "tapstart", "vmousedown"], t, { x: i[0], y: i[1] }),
								null == m &&
									((e.data.bgActivePosistion = { x: o[0], y: o[1] }), e.redrawHint("select", !0), e.redraw()),
						...
						if (t.touches.length >= 1) {
							for (var A = (e.touchData.startPosition = [null, null, null, null, null, null]), O = 0; O < i.length; O++)
								A[O] = a[O] = i[O];
							var R = t.touches[0];
								...
								if (p) {
									...
									if (m(g[0]) && m(g[1]))
										if (((ie.x += g[0]), (ie.y += g[1]), re))
											e.redrawHint("eles", !0),
												(ae = e.touchData.dragDelta) && m(ae[0]) && m(ae[1]) && ((ie.x += ae[0]), (ie.y += ae[1]));
									(e.hoverData.draggingEles = !0),
							...
							if (null != i) {
								...
								d(g),
									...
									v &&
										(i.emit("freeon"),
										g.emit("free"),
										e.dragData.didDrag && (i.emit("dragfreeon"), g.emit("dragfree"))),
		...
		return (this.nodeShapes[e] = {
			...
			intersectLine: function (e, t, n, r, i, a, o) {
				return (function (e, t, n, r, i, a, o, s) {
					for (
						var l, u = [], c = new Array(n.length), d = a / 2, h = o / 2, p = tn(a, o), f = 0;
						f < n.length / 4;
						f++
					) {
						var g,
						...
						var y = r + d * n[4 * f],
							...
							k = y + x * n[g],
							C = m + x * n[g + 1];
						0 === f ? ((c[n.length - 2] = w), (c[n.length - 1] = E)) : ((c[4 * f - 2] = w), (c[4 * f - 1] = E)),
							(c[4 * f] = k),
							(c[4 * f + 1] = C);
						var S = n[v + 1],
							P = -n[v];
						S * n[g] + P * n[g + 1] < 0 && ((S *= -1), (P *= -1)),
							0 !== (l = Ht(e, t, r, i, w + S * p, E + P * p, p)).length && u.push(l[0], l[1]);
					}
					for (var D = 0; D < c.length / 4; D++)
						0 !== (l = Gt(e, t, r, i, c[4 * D], c[4 * D + 1], c[4 * D + 2], c[4 * D + 3], !1)).length &&
							u.push(l[0], l[1]);
					if (u.length > 2) {
						for (
							var T = [u[0], u[1]], _ = Math.pow(T[0] - e, 2) + Math.pow(T[1] - t, 2), M = 1;
							M < u.length / 2;
							M++
						) {
			...
			checkPoint: function (e, t, n, r, i, a, o) {
				return (function (e, t, n, r, i, a, o) {
					for (
						var s = new Array(n.length), l = a / 2, u = o / 2, c = tn(a, o), d = c * c, h = 0;
						h < n.length / 4;
						h++
					) {
						var p,
		...
		return (this.nodeShapes["cut-rectangle"] = this.nodeShapes.cutrectangle =
			{
				...
				intersectLine: function (e, t, n, r, i, a, o) {
					var s = this.generateCutTrianglePts(n + 2 * o, r + 2 * o, e, t),
						l = [].concat.apply(
							[],
							[s.topLeft.splice(0, 4), s.topRight.splice(0, 4), s.bottomRight.splice(0, 4), s.bottomLeft.splice(0, 4)],
						);
					return Ut(i, a, l, e, t);
				},
				checkPoint: function (e, t, n, r, i, a, o) {
...
var Hl = function (e) {
	...
	Kl = Hl.prototype;
(Kl.clientFunctions = ["redrawHint", "render", "renderTo", "matchCanvasSize", "nodeShapeImpl", "arrowShapeImpl"]),
	(Kl.init = function (e) {
		var t = this;
...
var Gl = function (e) {
	...
	Zl = { dequeue: "dequeue", downscale: "downscale", highQuality: "highQuality" },
	$l = Xe({
		getKey: null,
...
(Jl.reasons = Zl),
	...
	(Jl.dequeue = function (e) {
		for (
			var t = this.getElementQueue(), n = this.getElementKeyToQueue(), r = [], i = this.lookup, a = 0;
			a < 1 && t.size() > 0;
			a++
		) {
			var o = t.pop(),
			...
			if (i.replacement) t.pop();
				...
				a && (this.drawEleInLayer(i, a, i.level, e), r++),
					...
					0 === i.elesQueue.length &&
						(t.pop(), (i.reqs = 0), i.replaces && this.applyLayerReplacement(i), this.requestRedraw());
			}
		}
		return n;
	}),
...
(du.drawCachedElement = function (e, t, n, r, i, a) {
	...
	if (0 !== h.w && 0 !== h.h && t.visible() && (!r || zt(h, r))) {
		...
		o.drawElementUnderlay(e, t),
			...
			f &&
				!g &&
				(o.drawCachedElementPortion(e, t, c, n, i, p, fu, yu), o.drawCachedElementPortion(e, t, d, n, i, p, gu, yu)),
...
(mu.drawEdgeOverlay = bu("overlay")),
	...
	(mu.drawArrowShape = function (e, t, n, r, i, a, o, s, l) {
		...
		h ||
			...
			("hollow" !== n && "both" !== n) ||
				((t.lineWidth = a / (d ? v : 1)), (t.lineJoin = "miter"), d ? t.stroke(u) : t.stroke()),
		...
		drawInscribedImage: function (e, t, n, r, i) {
			...
			if (
				...
				if (
					...
					b &&
						(e.save(),
						m.pathCache ? e.clip(m.pathCache) : (a.nodeShapes[a.getNodeShape(n)].draw(e, s, l, v, y), e.clip())),
		...
		n && ((p = n), e.translate(-p.x1, -p.y1)),
			null == i
				? (o.drawText(e, t, null, f, a),
				  t.isEdge() && (o.drawText(e, t, "source", f, a), o.drawText(e, t, "target", f, a)))
			...
			if (null != h && "" !== h && !isNaN(c) && !isNaN(d)) {
				...
				if (E > 0 || (C > 0 && k > 0)) {
					...
					if (E > 0) {
						...
						0 === N.indexOf("round") ? Eu(e, P, D, T, _, 2) : e.fillRect(P, D, T, _), (e.fillStyle = M);
					}
					if (C > 0 && k > 0) {
						var z = e.strokeStyle,
							I = e.lineWidth,
						...
						if (
							((e.strokeStyle = "rgba(" + L[0] + "," + L[1] + "," + L[2] + "," + k * s + ")"),
							(e.lineWidth = C),
							e.setLineDash)
						)
							switch (A) {
						...
						if ((e.strokeRect(P, D, T, _), "double" === A)) {
							var O = C / 2;
						...
						if (I > 0) {
							...
							if ("ellipse" === o) l.drawEllipsePath(a || e, n.x, n.y, c, h);
								...
								"round-diamond" === o
									...
									: "round-triangle" === o && ((f = (_ + R + I) * (Math.PI / 2)), (y = -(_ + R / 2 + I) / Math.PI)),
									0 !== f && ((s = (r + f) / r), (u = (i + f) / i)),
									l.drawRoundPolygonPath(a || e, n.x + v, n.y + y, r * s, i * u, p);
								...
								["rhomboid", "right-rhomboid", "round-tag", "tag", "vee"].includes(o)
							) {
...
(Su.getPixelRatio = function () {
	...
	(Su.matchCanvasSize = function (e) {
		...
		(e !== t.data.bufferCanvases[t.MOTIONBLUR_BUFFER_NODE] && e !== t.data.bufferCanvases[t.MOTIONBLUR_BUFFER_DRAG]) ||
			(o = s);
		var l,
			u = i * o,
			c = a * o;
	...
	(Su.render = function (e) {
		...
		function D(e, r) {
			...
			(e !== u.bufferContexts[o.MOTIONBLUR_BUFFER_NODE] && e !== u.bufferContexts[o.MOTIONBLUR_BUFFER_DRAG])
			...
			if (((o.textureDrawLastFrame = !0), !o.textureCache)) {
				...
				T.setTransform(1, 0, 0, 1, 0, 0),
					...
					((k = o.textureCache.viewport =
						{ zoom: l.zoom(), pan: l.pan(), width: o.canvasWidth, height: o.canvasHeight }).mpan = {
						x: (0 - k.pan.x) / k.zoom,
						y: (0 - k.pan.y) / k.zoom,
					});
			}
		...
		var z = l.extent(),
			...
			A = [];
		if (
			((A[o.NODE] = (!c[o.NODE] && h && !o.clearedForMotionBlur[o.NODE]) || o.clearingMotionBlur),
			...
			D(
				(_ = t || (O ? o.data.bufferContexts[o.MOTIONBLUR_BUFFER_NODE] : u.contexts[o.NODE])),
				h && !O ? "motionBlur" : void 0,
			),
				L ? o.drawCachedNodes(_, S.nondrag, s, z) : o.drawLayeredElements(_, S.nondrag, s, z),
		...
		if (!r && (c[o.DRAG] || n || A[o.DRAG])) {
			O = h && !A[o.DRAG] && 1 !== p;
			D(
				(_ = t || (O ? o.data.bufferContexts[o.MOTIONBLUR_BUFFER_DRAG] : u.contexts[o.DRAG])),
				h && !O ? "motionBlur" : void 0,
			),
				L ? o.drawCachedNodes(_, S.drag, s, z) : o.drawCachedElements(_, S.drag, s, z),
...
Pu.drawEllipsePath = function (e, t, n, r, i) {
	if ((e.beginPath && e.beginPath(), e.ellipse)) e.ellipse(t, n, r / 2, i / 2, 0, 0, 2 * Math.PI);
		...
		for (var a, o, s = r / 2, l = i / 2, u = 0 * Math.PI; u < 2 * Math.PI; u += Bu)
...
function Vu(e) {
	...
	(t.data.topCanvas = t.data.canvases[0]),
		t.data.canvases[Ru.NODE].setAttribute("data-id", "layer" + Ru.NODE + "-node"),
		t.data.canvases[Ru.SELECT_BOX].setAttribute("data-id", "layer" + Ru.SELECT_BOX + "-selectbox"),
		t.data.canvases[Ru.DRAG].setAttribute("data-id", "layer" + Ru.DRAG + "-drag");
